...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Actualizar') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->PK_MZGTCAMPESPECIFICOSCINE)),
...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes' => array(
        ...
        'FK1_MZGTCAMPESPECIFICOSCINE_INV_MZGTCAMPAMPLIOSCINE_PK',
        'MZGTCAMPESPECIFICOSCINE_NOMBRE',
        'MZGTCAMPESPECIFICOSCINE_CODIGO',
	),
)); ?>
