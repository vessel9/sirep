...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Actualizar') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->PK_MZGTLINEASINVESTIGACION)),
	//array('label'=>Yii::t('app', 'Eliminar') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->PK_MZGTLINEASINVESTIGACION), 'confirm'=>'Are you sure you want to delete this item?')),
