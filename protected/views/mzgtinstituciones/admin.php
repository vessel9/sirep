...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('mzgtinstituciones-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
					'name' => 'MZGTINSTITUCIONES_ESTADO',
					'value' => '($data->MZGTINSTITUCIONES_ESTADO == 0) ? Yii::t(\'app\', \'Inactivo\') : Yii::t(\'app\', \'Activo\')',
